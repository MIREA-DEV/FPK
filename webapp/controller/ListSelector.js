sap.ui.define([
	...
	return BaseObject.extend("ru.fpk.backend.model.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias ru.fpk.backend.model.ListSelector
		 */
		 ...
		 * @return {ru.fpk.backend.model.ListSelector} the list selector object for method chaining
		 * @public
		 */
