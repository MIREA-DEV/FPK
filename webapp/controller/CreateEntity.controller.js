sap.ui.define([
	...
	return BaseController.extend("ru.fpk.backend.controller.CreateEntity", {
		...
		onInit: function() {
			...
			this._oODataModel = this.getOwnerComponent().getModel();
	     	this._oODataModel.setSizeLimit(1000);  
		...
		_onCreate: function(oEvent) {
			...
			var oContext = this._oODataModel.createEntry("Firms", {
		...
		_fnEntityCreated: function(oData) {
			var sObjectPath = this.getModel().createKey("Firms", oData);
