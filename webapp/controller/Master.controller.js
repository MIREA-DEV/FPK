/*global history */
sap.ui.define([
	"ru/fpk/backend/controller/BaseController",
	"sap/ui/model/json/JSONModel",
	"sap/ui/model/Filter",
	"sap/ui/model/FilterOperator",
	"sap/m/GroupHeaderListItem",
	"sap/ui/Device",
	"ru/fpk/backend/model/formatter",
	"sap/m/MessageBox"
], function(BaseController, JSONModel, Filter, FilterOperator, GroupHeaderListItem, Device, formatter, MessageBox) {
	"use strict";

	return BaseController.extend("ru.fpk.backend.controller.Master", {
				...
				function(mParams) {
					...
					if (!mParams.list.getSelectedItem()) {
						this.getRouter().navTo("object", {
							FirmID: encodeURIComponent(mParams.firstListitem.getBindingContext().getProperty("FirmID"))
						}, true);
					}
				}.bind(this),
				function(mParams) {
		...
		_showDetail: function(oItem) {
			...
			this.getRouter().navTo("object", {
				FirmID: encodeURIComponent(oItem.getBindingContext().getProperty("FirmID"))
			}, bReplace);
		},
